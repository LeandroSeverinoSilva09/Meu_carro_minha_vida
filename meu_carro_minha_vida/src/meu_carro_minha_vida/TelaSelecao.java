...
/**
 * A tela de selcção serva para o usuario selecioar qual opção deseja seguir,
 * sendo ela qual combustível compensa mais para ser abastecido ou saber qual
 * será o custo da manutenção do seu automóvel.
 * 
 * @author Jõao
 */
